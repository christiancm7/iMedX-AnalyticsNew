    ...
    <div className='app-main'>
      ...
      <div className='app-main__outer'>
        <div className='app-main__inner'>
          ...
          <Route
            path={`${match.url}/datatables-custom-components`}
            component={DataTableCustomComps}
          />
          <Route
            path={`${match.url}/datatables-editable`}
            component={DataTableEditable}
          />
          <Route
            path={`${match.url}/datatables-fixed-header`}
            component={DataTableFixedHeader}
          />
          <Route
            path={`${match.url}/datatables-aggregation`}
            component={DataTablePivoting}
          />
          <Route
