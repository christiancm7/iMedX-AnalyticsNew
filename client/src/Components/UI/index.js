    ...
    <div className='app-main'>
      ...
      <div className='app-main__outer'>
        <div className='app-main__inner'>
          ...
          <Route
            path={`${match.url}/loading-blocks`}
            component={BlockLoadingExample}
          />
          ...
          <Route
            path={`${match.url}/sticky-elements`}
            component={StickyElements}
          />

          {/* Scrollable Elements */}

          <Route
            path={`${match.url}/scrollable-elements`}
            component={ScrollableElements}
          />
          ...
          <Route
            path={`${match.url}/image-crop`}
            component={ImageCropExample}
          />

          {/* Guided Tours */}

          <Route
            path={`${match.url}/guided-tours`}
            component={GuidedToursExample}
          />

          {/* Pagination */}

          <Route
            path={`${match.url}/pagination`}
