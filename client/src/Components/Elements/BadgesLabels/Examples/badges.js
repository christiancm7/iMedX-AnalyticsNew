              ...
              <Col lg='6'>
                ...
                <Card className='main-card mb-3'>
                  <CardBody>
                    ...
                    <Button className='mb-2 mr-2' color='info'>
                      Primary
                      <span className='badge badge-secondary badge-dot badge-dot-lg'>
                        {' '}
                      </span>
                    </Button>
                    <Button className='mb-2 mr-2' color='secondary'>
                      Secondary
                      <span className='badge badge-primary badge-dot badge-dot-lg'>
                        {' '}
                      </span>
                    </Button>
                    <Button className='mb-2 mr-2' color='success'>
                      Success
                      <span className='badge badge-success badge-dot badge-dot-lg'>
                        {' '}
                      </span>
                    </Button>
                    <Button className='mb-2 mr-2' color='info'>
                      Info
                      <span className='badge badge-info badge-dot badge-dot-lg'>
                        {' '}
                      </span>
                    </Button>
                    <Button className='mb-2 mr-2' color='warning'>
                      Warning
                      <span className='badge badge-warning badge-dot badge-dot-lg'>
                        {' '}
                      </span>
                    </Button>
                    <Button className='mb-2 mr-2' color='danger'>
                      Danger
                      <span className='badge badge-focus badge-dot badge-dot-lg'>
                        {' '}
                      </span>
                    </Button>
                    <Button className='mb-2 mr-2' color='focus'>
                      Focus
                      <span className='badge badge-danger badge-dot badge-dot-lg'>
                        {' '}
                      </span>
                    </Button>
                    <Button className='mb-2 mr-2' color='alternate'>
                      Alt
                      <span className='badge badge-alternate badge-dot badge-dot-lg'>
                        {' '}
                      </span>
                    </Button>
                    <Button className='mb-2 mr-2' color='light'>
                ...
                <Card className='main-card mb-3'>
                  <CardBody>
                    ...
                    <button className='mb-2 mr-2 btn-icon btn-icon-only btn btn-link btn-sm'>
                      <i className='pe-7s-settings btn-icon-wrapper font-size-xlg'>
                        {' '}
                      </i>
                      <span className='badge badge-warning badge-dot badge-dot-sm'>
                        {' '}
                      </span>
                    </button>
                    <button className='mb-2 mr-2 btn-icon btn-icon-only btn btn-link btn-sm'>
                      <i className='lnr-license btn-icon-wrapper font-size-xlg'>
                        {' '}
                      </i>
                      <span className='badge badge-primary badge-dot badge-dot'>
                        {' '}
                      </span>
                    </button>
                    <button className='mb-2 mr-4 btn-icon btn-icon-only btn btn-link btn-sm'>
                      <i className='lnr-map btn-icon-wrapper font-size-xlg'>
                        {' '}
                      </i>
                      <span className='badge badge-success badge-dot badge-dot-lg'>
                        {' '}
                      ...
                      <Row className='no-gutters'>
                        <Col xl='4' sm='6'>
                          ...
                          >
                            ...
                            <span className='badge badge-primary badge-dot badge-dot-lg badge-dot-inside'>
                              {' '}
                            </span>
                            Primary
                          </Button>
                        ...
                        <Col xl='4' sm='6'>
                          ...
                          >
                            ...
                            <span className='badge badge-danger badge-dot badge-dot-inside'>
                              {' '}
                            </span>
                            Success
                          </Button>
                        ...
                        <Col xl='4' sm='6'>
                          ...
                          >
                            ...
                            <span className='badge badge-primary badge-dot badge-dot-inside'>
                              {' '}
                            </span>
                            Warning
                          </Button>
                      ...
                      <Row className='no-gutters'>
                        <Col sm='6'>
                          ...
                          >
                            ...
                            <span className='badge badge-info badge-dot badge-dot-lg badge-dot-inside'>
                              {' '}
                            </span>
                            Primary
                          </Button>
                        ...
                        <Col sm='6'>
                          ...
                          >
                            ...
                            <span className='badge badge-alternate badge-dot badge-dot-lg badge-dot-inside'>
                              {' '}
                            </span>
                            Success
                          </Button>
                  ...
                  <CardBody>
                    ...
                    <Row>
                      ...
                      <Col xl='4' sm='6'>
                        ...
                        >
                          <i className='lnr-map btn-icon-wrapper'> </i>
                          <span className='badge badge-success badge-dot badge-dot-sm badge-dot-inside'>
                            {' '}
                          </span>
                          Secondary
                        </Button>
                      ...
                      <Col xl='4' sm='6'>
                        ...
                        >
                          ...
                          <span className='badge badge-focus badge-dot badge-dot-sm badge-dot-inside'>
                            {' '}
                          </span>
                          Focus
                        </Button>
                      ...
                      <Col xl='4' sm='6'>
                        ...
                        >
                          ...
                          <span className='badge badge-alternate badge-dot badge-dot-inside'>
                            {' '}
                          </span>
                          Dark
                        </Button>
