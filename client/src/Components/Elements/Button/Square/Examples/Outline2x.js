            ...
            <Col lg='6'>
              <Card className='main-card mb-3'>
                <CardBody>
                  ...
                  <Button
                    outline
                    className='mb-2 mr-2 btn-outline-2x btn-square'
                    color='info'
                  >
                    Primary
                  </Button>
              ...
              <Card className='main-card mb-3'>
                <CardBody>
                  ...
                  <div className='text-center'>
                    <Button
                      outline
                      className='btn-wide btn-outline-2x mb-2 mr-2 btn-square'
                      size='lg'
                      color='info'
                    >
                      Wider Large
              ...
              <Card className='main-card mb-3'>
                <CardBody>
                  ...
                  <div className='text-center'>
                    <Button
                      outline
                      className='btn-outline-2x mb-2 mr-2 btn-square'
                      size='lg'
                      color='info'
                    >
                      Large
                ...
                <CardBody>
                  ...
                  <div className='text-center'>
                    <ButtonGroup size='sm' className='mb-2'>
                      <Button
                        className='btn-outline-2x btn-square'
                        outline
                        color='info'
