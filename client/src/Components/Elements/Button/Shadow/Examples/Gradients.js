            ...
            <Col lg='6'>
              <Card className='main-card mb-3'>
                <CardBody>
                  ...
                  <Button className='mb-2 mr-2 btn-shadow btn-gradient-primary'>
                    Primary
                  </Button>
                  <Button className='mb-2 mr-2 btn-shadow btn-gradient-secondary'>
                    Secondary
                  </Button>
                  <Button className='mb-2 mr-2 btn-shadow btn-gradient-success'>
                    Success
                  </Button>
                  <Button className='mb-2 mr-2 btn-shadow btn-gradient-info'>
                    Info
                  </Button>
                  <Button className='mb-2 mr-2 btn-shadow btn-gradient-warning'>
                    Warning
                  </Button>
                  <Button className='mb-2 mr-2 btn-shadow btn-gradient-danger'>
                    Danger
                  </Button>
                  <Button className='mb-2 mr-2 btn-shadow btn-gradient-focus'>
                    Focus
                  </Button>
                  <Button className='mb-2 mr-2 btn-shadow btn-gradient-alternate'>
                    Alt
                  </Button>
                  <Button className='mb-2 mr-2 btn-shadow btn-gradient-light'>
                    Light
                  </Button>
                  <Button className='mb-2 mr-2 btn-shadow btn-gradient-dark'>
                    Dark
                  </Button>
                  <Button className='mb-2 mr-2 btn-shadow btn-gradient-link'>
                    link
                  </Button>
                </CardBody>
              </Card>
            ...
            <Col lg='6'>
              <Card className='main-card mb-3'>
                <CardBody>
                  ...
                  <Button
                    className='mb-2 mr-2 btn-shadow-danger btn-gradient-danger'
                    color='danger'
                  >
                    Danger
                  </Button>
                  <Button
                    className='mb-2 mr-2 btn-shadow-focus btn-gradient-focus'
                    color='focus'
                  >
                    Focus
                  </Button>
                  ...
                  <Button
                    className='mb-2 mr-2 btn-shadow-light btn-gradient-light'
                    color='light'
                  >
                    Light
                  </Button>
            ...
            <Col lg='6'>
              <Card className='main-card mb-3'>
                <CardBody>
                  ...
                  <Button
                    active
                    className='mb-2 mr-2 btn-shadow btn-gradient-info'
                  >
                    Info
                  </Button>
                  <Button
                  ...
                  <Button
                    active
                    className='mb-2 mr-2 btn-shadow btn-gradient-focus'
                  >
                    Focus
                  </Button>
                  <Button
                  ...
                  <Button
                    active
                    className='mb-2 mr-2 btn-shadow btn-gradient-light'
                  >
                    Light
                  </Button>
                  <Button
                    active
                    className='mb-2 mr-2 btn-shadow btn-gradient-dark'
                  >
                    Dark
                  </Button>
                  <Button
                    active
                    className='mb-2 mr-2 btn-shadow btn-gradient-link'
                  >
                    link
                  </Button>
                </CardBody>
