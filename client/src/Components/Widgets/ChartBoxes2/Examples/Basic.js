      ...
      <Fragment>
        ...
        >
          <Container fluid>
                        ...
                        <div className='widget-numbers'>
                          <div className='widget-chart-flex'>
                            ...
                            <div className='widget-title ml-2 font-size-lg text-muted'>
                              <span className='text-success pr-2'>+14%</span>
            ...
            <Row>
              <Col md='6' lg='4'>
                <div className='card mb-3 widget-chart widget-chart2 text-left widget-chart-hover card-btm-border border-primary'>
                  <div className='widget-chat-wrapper-outer'>
                    <div className='widget-chart-content'>
                      <div className='widget-chart-flex'>
                        <div className='widget-numbers'>
              ...
              <Col md='6' lg='4'>
                <div className='card mb-3 widget-chart widget-chart2 text-left widget-chart-hover card-btm-border border-success'>
                  <div className='widget-chat-wrapper-outer'>
                    <div className='widget-chart-content'>
                      <div className='widget-chart-flex'>
                        <div className='widget-numbers'>
              ...
              <Col md='6' lg='4'>
                <div className='card mb-3 widget-chart widget-chart2 text-left widget-chart-hover card-btm-border border-danger'>
                  <div className='widget-chat-wrapper-outer'>
                    <div className='widget-chart-content'>
                      <div className='widget-chart-flex'>
                        <div className='widget-numbers'>
