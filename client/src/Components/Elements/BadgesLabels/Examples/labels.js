                ...
                <Card className='main-card mb-3'>
                  <CardBody>
                    ...
                    <Button className='mb-2 mr-2' color='link'>
                      Link 1<span className='badge badge-primary'>NEW</span>
                    </Button>
                    <Button className='mb-2 mr-2' color='link'>
                      Link 2<span className='badge badge-success'>NEW</span>
                    </Button>
                    <Button className='mb-2 mr-2' color='link'>
                      Link 3<span className='badge badge-danger'>NEW</span>
                    </Button>
                    <Button className='mb-2 mr-2' color='link'>
                      Link 4<span className='badge badge-warning'>NEW</span>
                    </Button>
                  </CardBody>
                </Card>
              </Col>
