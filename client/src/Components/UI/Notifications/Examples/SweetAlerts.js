            ...
            <Col md='3'>
              <Card className='mb-3 text-center'>
                <CardBody>
                  ...
                  <Button
                    color='danger'
                    onClick={() => this.setState({ message34: true })}
                  >
                    Show Alert
                  </Button>
                  <SweetAlert
            ...
            <Col md='3'>
              <Card className='mb-3 text-center'>
                <CardBody>
                  ...
                  <Button
                    color='info'
                    onClick={() => this.setState({ message32: true })}
                  >
                    Show Alert
                  </Button>
                  <SweetAlert
            ...
            <Col md='3'>
              <Card className='mb-3 text-center'>
                <CardBody>
                  ...
                  <Button
                    color='warning'
                    onClick={() => this.setState({ message33: true })}
                  >
                    Show Alert
                  </Button>
                  <SweetAlert
            ...
            <Col md='3'>
              <Card className='mb-3 text-center'>
                <CardBody>
                  ...
                  <Button
                    color='info'
                    onClick={() => this.setState({ message1: true })}
                  >
                    Show Alert
                  </Button>
                  <SweetAlert
            ...
            <Col md='3'>
              <Card className='mb-3 text-center'>
                <CardBody>
                  ...
                  <Button
                    color='info'
                    onClick={() => this.setState({ message2: true })}
                  >
                    Show Alert
                  </Button>
                  <SweetAlert
            ...
            <Col md='3'>
              <Card className='mb-3 text-center'>
                <CardBody>
                  ...
                  <Button
                    color='info'
                    onClick={() => this.setState({ message4: true })}
                  >
                    Show Alert
                  </Button>
                  <SweetAlert
