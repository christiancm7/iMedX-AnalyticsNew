              ...
              <Card className='main-card mb-3'>
                <CardBody>
                  ...
                  <div className='text-center'>
                    <Button
                      outline
                      className='btn-wide mb-2 mr-2 btn-pill btn-dashed'
                      size='lg'
                      color='info'
                    >
                      Wider Large
              ...
              <Card className='main-card mb-3'>
                <CardBody>
                  ...
                  <Row className='text-center'>
                    ...
                    <Col md='3'>
                      <LaddaButton
                        className='mb-2 mr-2 btn btn-pill btn-dashed btn-outline-focus'
                    ...
                    <Col md='3'>
                      <LaddaButton
                        className='mb-2 mr-2 btn btn-pill btn-dashed btn-outline-light'
                    ...
                    <Col md='3'>
                      <LaddaButton
                        className='mb-2 mr-2 btn btn-pill btn-dashed btn-outline-dark'
                  ...
                  <Row className='text-center'>
                    ...
                    <Col md='3'>
                      <LaddaButton
                        className='mb-2 mr-2 btn btn-pill btn-dashed btn-outline-info'
